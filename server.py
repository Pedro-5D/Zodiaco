...
CORS(app, resources={r"/*": {
    "origins": ["https://zodiaco-02nu.onrender.com"],
...
ANNUAL_PRECESSION_RATE = 50.2908 / 3600.0  # Aproximadamente 50 segundos de arco por año
...
def calculate_chart():
    ...
    try:
        ...
        calculate_analysis = data.get('calculateAnalysis', False)
        use_sidereal = data.get('useSidereal', False)  # Parámetro para zodiaco sideral
        include_stars = data.get('includeStars', False)  # Parámetro para estrellas fijas
        ...
        if calculate_analysis:
            ...
            houses_analysis = calcular_analisis_casas(positions, is_dry)
            result["houses_analysis"] = houses_analysis
        
        # Calcular posiciones de estrellas fijas si se solicita
        if include_stars:
            # Calcular posiciones de estrellas ajustadas por precesión
            stars_positions = calculate_star_positions(date)
            # Buscar aspectos (conjunciones) entre estrellas y planetas
            ...
            active_stars = [
                {
                    ...
                    "effect": stars_positions[aspect["star"]]["effect"],
            ...
            # Añadir tabla de dignidades
            dignity_table = calcular_tabla_dignidades(positions)
            result["dignity_table"] = dignity_table
            
            # Añadir interpretaciones
            interpretations = generar_interpretaciones(positions, aspects, is_dry)
...
# Añadir estas funciones para el cálculo de estrellas fijas
